...
const themes: Theme[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: ["Les embouts sont-ils remplaçables ?", "Are the tips replaceable?", "Sind die Aufsätze austauschbar?"], a: ["Oui. legmio sera livrée avec un embout standard en TPU, interchangeable avec les embouts du marché (diamètre 19mm).", "Yes. legmio will come with a standard TPU tip, interchangeable with tips available on the market (19mm diameter).", "Ja. legmio wird mit einem Standardaufsatz aus TPU geliefert werden, der mit im Handel erhältlichen Aufsätzen (Durchmesser 19 mm) austauschbar ist."] },
    ],
  },
  {
    title: ["Embouts", "Tips", "Aufsätze"],
    items: [
      { q: ["L'embout de legmio est-il interchangeable ?", "Is the legmio tip interchangeable?", "Ist der Aufsatz von legmio austauschbar?"], a: ["Oui, très facilement et sans outil. legmio est compatible avec les embouts standards du marché de 19mm de diamètre.", "Yes, very easily and without any tool. legmio is compatible with standard 19mm diameter market tips.", "Ja, sehr einfach und ohne Werkzeug. legmio ist mit handelsüblichen Standardaufsätzen mit 19 mm Durchmesser kompatibel."] },
  ...
  },
  {
    ...
    items: [
      ...
      { q: ["Peut-on utiliser legmio en extérieur / sur terrain irrégulier ?", "Can legmio be used outdoors / on uneven terrain?", "Kann legmio im Freien / auf unebenem Gelände verwendet werden?"], a: ["Oui. L'embout interchangeable permet d'adapter legmio à différents types de sols. Le Flexyfoot (compatible 19mm) est particulièrement recommandé pour l'extérieur et les sols irréguliers.", "Yes. The interchangeable tip allows legmio to be adapted to different types of ground. The Flexyfoot (19mm compatible) is particularly recommended for outdoor use and uneven ground.", "Ja. Der austauschbare Aufsatz ermöglicht die Anpassung von legmio an verschiedene Bodenarten. Der Flexyfoot (19 mm kompatibel) wird besonders für den Außenbereich und unebenes Gelände empfohlen."] },
      ...
      { q: ["Combien de temps faut-il pour s'adapter à legmio ?", "How long does it take to get used to legmio?", "Wie lange dauert es, sich an legmio zu gewöhnen?"], a: ["La prise en main est immédiate : legmio s'utilise comme une canne anglaise classique dès les premiers pas, sans rien réapprendre. Ce qui demande un peu d'habitude, c'est le mode mains libres — il devient un réflexe en quelques heures pour certains, une à deux semaines pour d'autres, comme avec toute nouvelle aide à la marche.", "You can use it right away: from the first steps, legmio works like an ordinary forearm crutch, with nothing to relearn. What takes a little habit is the hands-free mode — it becomes second nature within a few hours for some, one to two weeks for others, as with any new walking aid.", "Der Einstieg ist sofort möglich: Ab dem ersten Schritt funktioniert legmio wie eine gewöhnliche Unterarmgehstütze, ohne Umlernen. Etwas Gewöhnung braucht der Freihand-Modus — er wird bei manchen schon nach wenigen Stunden zur Selbstverständlichkeit, bei anderen nach ein bis zwei Wochen, wie bei jeder neuen Gehhilfe."] },
