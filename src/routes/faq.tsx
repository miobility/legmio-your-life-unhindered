...
const themes: Theme[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: ["Ma mutuelle peut-elle compléter le remboursement ?", "Can my supplementary insurance top up the reimbursement?", "Kann meine Zusatzversicherung die Erstattung ergänzen?"], a: ["Oui, selon ton contrat de mutuelle ou d'assurance. Tu peux aussi te rapprocher d'une équipe locale d'accompagnement aides techniques (EqLAAT) : elle réalise une évaluation et t'aide à monter un dossier PCH ou MDPH.", "Yes, depending on your supplementary health insurance policy. In France you can also contact a local assistive-technology support team (EqLAAT): it carries out an assessment and helps you build a PCH or MDPH application.", "Ja, je nach Vertrag Ihrer Zusatzversicherung. In Frankreich können Sie sich zudem an ein lokales Beratungsteam für Hilfsmittel (EqLAAT) wenden: Es führt eine Bewertung durch und hilft beim Antrag auf PCH oder MDPH."] },
