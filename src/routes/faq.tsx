...
const themes: Theme[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: ["legmio est-elle utilisable en cas de faiblesse ou perte de force dans les mains ?", "Can legmio be used in case of weakness or loss of strength in the hands?", "Kann legmio bei Schwäche oder Kraftverlust in den Händen verwendet werden?"], a: ["Oui. legmio ne nécessite pas de poigne ni de capacité à fermer la main — un simple appui du poignet suffit.", "Yes. legmio does not require a grip or the ability to close the hand — a simple wrist support is enough.", "Ja. legmio erfordert weder einen Griff noch die Fähigkeit, die Hand zu schließen — eine einfache Handgelenkstütze genügt."] },
  ...
  },
  {
    ...
    items: [
      { q: ["legmio est-elle remboursée par la Sécurité Sociale ?", "Is legmio reimbursed by Social Security?", "Wird legmio von der Sozialversicherung erstattet?"], a: ["Une prise en charge partielle est prévue sur prescription médicale, sur la base de la nomenclature béquille (LPP), entre 12,20€ et 18,29€.", "Partial coverage is provided with a medical prescription, based on the crutch nomenclature (LPP), between €12.20 and €18.29.", "Bei ärztlicher Verschreibung ist eine teilweise Kostenübernahme auf Basis der Krücken-Nomenklatur (LPP) zwischen 12,20 € und 18,29 € vorgesehen."] },
      ...
      { q: ["Existe-t-il une prise en charge dans le cadre professionnel ?", "Is there any coverage available in a professional context?", "Gibt es eine Kostenübernahme im beruflichen Kontext?"], a: ["Oui. En contexte emploi, legmio peut être prise en charge jusqu'à 90% via l'Agefiph (secteur privé, sous condition RQTH) ou le FIPHFP (fonction publique), avec un reste à charge quasi nul.", "Yes. In an employment context, legmio can be covered up to 90% via Agefiph (private sector, subject to RQTH status) or FIPHFP (public sector), with almost no out-of-pocket cost.", "Ja. Im beruflichen Kontext kann legmio über die Agefiph (Privatsektor, mit RQTH-Status) oder den FIPHFP (öffentlicher Dienst) bis zu 90 % übernommen werden, mit einem nahezu vollständigen Wegfall des Eigenanteils."] },
    ],
  },
  {
    title: ["Commande et prix", "Order and price", "Bestellung und Preis"],
    items: [
      { q: ["Quel est le prix de legmio ?", "What is the price of legmio?", "Was kostet legmio?"], a: ["legmio sera très probablement disponible au prix de 200€ TTC.", "legmio will most likely be available at a price of 200€ incl. VAT.", "legmio wird voraussichtlich zu einem Preis von 200€ inkl. MwSt. erhältlich sein."] },
