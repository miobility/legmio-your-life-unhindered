...
const themes: Theme[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: ["Les embouts sont-ils remplaçables ?", "Are the tips replaceable?", "Sind die Aufsätze austauschbar?"], a: ["Oui. legmio sera livrée avec un embout standard en TPU, interchangeable avec les embouts du marché (diamètre 16mm).", "Yes. legmio will come with a standard TPU tip, interchangeable with tips available on the market (16mm diameter).", "Ja. legmio wird mit einem Standardaufsatz aus TPU geliefert werden, der mit im Handel erhältlichen Aufsätzen (Durchmesser 16 mm) austauschbar ist."] },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: ["Combien de temps faut-il pour s'adapter à legmio ?", "How long does it take to get used to legmio?", "Wie lange dauert es, sich an legmio zu gewöhnen?"], a: ["La prise en main est immédiate : legmio s'utilise comme une canne anglaise classique dès les premiers pas, sans rien réapprendre. Ce qui demande un peu d'habitude, c'est le mode mains libres — il devient un réflexe en quelques jours, deux semaines pour certains, comme avec toute nouvelle aide à la marche.", "You can use it right away: from the first steps, legmio works like an ordinary forearm crutch, with nothing to relearn. What takes a little habit is the hands-free mode — it becomes second nature within a few days, up to two weeks for some, as with any new walking aid.", "Der Einstieg ist sofort möglich: Ab dem ersten Schritt funktioniert legmio wie eine gewöhnliche Unterarmgehstütze, ohne Umlernen. Etwas Gewöhnung braucht der Freihand-Modus — er wird binnen weniger Tage zur Selbstverständlichkeit, bei manchen nach zwei Wochen, wie bei jeder neuen Gehhilfe."] },
