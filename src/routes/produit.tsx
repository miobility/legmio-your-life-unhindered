        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            {[
              ...
              [tr("Combien de temps pour s'adapter ?", "How long does it take to adapt?", "Wie lange dauert die Eingewöhnung?"), tr("Immédiate en mode classique : legmio s'utilise comme une canne anglaise dès les premiers pas. Le mode mains libres devient un réflexe en quelques heures pour certains, plusieurs jours pour d'autres.", "Immediate in classic mode: from the first steps, legmio works like an ordinary forearm crutch. The hands-free mode becomes second nature within a few hours for some, several days for others.", "Sofort im klassischen Modus: Ab dem ersten Schritt funktioniert legmio wie eine gewöhnliche Unterarmgehstütze. Der Freihand-Modus wird bei manchen nach wenigen Stunden zur Selbstverständlichkeit, bei anderen nach mehreren Tagen.")],
