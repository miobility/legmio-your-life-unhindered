        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            {[
              ...
              [tr("Faut-il de la force dans les mains ?", "Do I need hand strength?", "Braucht man Kraft in den Händen?"), tr("Un peu, mais la poignée réduit nettement le besoin en force de préhension. À valider avec ton médecin MPR selon ta situation.", "A little, but the grip clearly reduces the need for gripping strength. To be confirmed with your rehabilitation doctor.", "Ein wenig, aber der Griff verringert den Bedarf an Greifkraft deutlich. Mit Ihrer Reha-Ärztin oder Ihrem Reha-Arzt abzuklären.")],
              [tr("Combien de temps pour s'adapter ?", "How long does it take to adapt?", "Wie lange dauert die Eingewöhnung?"), tr("Immédiate en mode classique : legmio s'utilise comme une canne anglaise dès les premiers pas. Le mode mains libres devient un réflexe en quelques heures pour certains, une à deux semaines pour d'autres.", "Immediate in classic mode: from the first steps, legmio works like an ordinary forearm crutch. The hands-free mode becomes second nature within a few hours for some, one to two weeks for others.", "Sofort im klassischen Modus: Ab dem ersten Schritt funktioniert legmio wie eine gewöhnliche Unterarmgehstütze. Der Freihand-Modus wird bei manchen nach wenigen Stunden zur Selbstverständlichkeit, bei anderen nach ein bis zwei Wochen.")],
              [tr("Est-elle remboursée ?", "Is it reimbursed?", "Wird sie erstattet?"), tr("Pas encore : legmio n'est pas commercialisée. Nous visons d'abord la nomenclature béquille (LPP), remboursée entre 12,20 € et 18,29 € sur prescription, puis une ligne propre à legmio. En contexte emploi, l'Agefiph et le FIPHFP financent les aides techniques jusqu'à 90 %.", "Not yet: legmio is not on sale. We are aiming first for the French crutch nomenclature (LPP), reimbursed between €12.20 and €18.29 on prescription, then a line of its own. At work, Agefiph and FIPHFP fund assistive devices up to 90%.", "Noch nicht: legmio ist nicht im Handel. Wir streben zuerst die französische Krücken-Nomenklatur (LPP) an, erstattet mit 12,20 € bis 18,29 € auf Verordnung, danach eine eigene Position. Im Beruf fördern Agefiph und FIPHFP Hilfsmittel mit bis zu 90 %.")],
