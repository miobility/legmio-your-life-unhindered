  ...
  return (
    <div style={{ backgroundColor: INK }}>
      <section style={{ backgroundColor: INK_SOFT }} className="px-4 sm:px-6 py-16 text-center">
        <h1 className="titre-page font-display font-bold" style={{ color: WHITE }}>{tr("Mentions légales", "Legal notice", "Impressum")}</h1>
      </section>
      <section className="px-4 sm:px-6 py-16">
        <article className="max-w-[680px] mx-auto text-[15px] leading-relaxed space-y-6" style={{ color: MUTED_INK }}>
          <div>
            <h2 className="titre-section font-display font-bold mt-4 mb-4" style={{ color: WHITE }}>{tr("Éditeur du site", "Site publisher", "Herausgeber der Website")}</h2>
          ...
          <div>
            <h2 className="titre-section font-display font-bold mt-6 mb-4" style={{ color: WHITE }}>{tr("Hébergeur", "Host", "Hosting-Anbieter")}</h2>
          ...
          <div>
            <h2 className="titre-section font-display font-bold mt-6 mb-4" style={{ color: WHITE }}>{tr("Propriété intellectuelle", "Intellectual property", "Geistiges Eigentum")}</h2>
            ...
            <p className="mt-4">{tr("La béquille legmio fait l'objet du brevet FR2411206, déposé en octobre 2024, détenu par SATT Lutech avec licence exclusive accordée à miobility.", "The legmio crutch is the subject of patent FR2411206, filed in October 2024, held by SATT Lutech with an exclusive license granted to miobility.", "Die legmio-Krücke ist Gegenstand des im Oktober 2024 angemeldeten Patents FR2411206, das von SATT Lutech gehalten wird, mit einer miobility gewährten Exklusivlizenz.")}</p>
            <p className="mt-4">{tr("Toute reproduction, représentation, modification, publication ou adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite sans autorisation écrite préalable de miobility.", "Any reproduction, representation, modification, publication or adaptation of all or part of the site's elements, by any means or process, is prohibited without prior written authorization from miobility.", "Jegliche Vervielfältigung, Darstellung, Änderung, Veröffentlichung oder Anpassung sämtlicher oder eines Teils der Website-Elemente, gleich mit welchem Mittel oder Verfahren, ist ohne vorherige schriftliche Genehmigung von miobility untersagt.")}</p>
          </div>

          <div>
            <h2 className="titre-section font-display font-bold mt-6 mb-4" style={{ color: WHITE }}>{tr("Limitation de responsabilité", "Limitation of liability", "Haftungsbeschränkung")}</h2>
