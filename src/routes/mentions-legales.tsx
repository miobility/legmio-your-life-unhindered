    ...
    <div style={{ backgroundColor: INK }}>
      ...
      <section className="px-4 sm:px-6 py-16">
        <article className="max-w-[680px] mx-auto text-[15px] leading-relaxed space-y-6" style={{ color: MUTED_INK }}>
          <div>
            <h2 className="titre-section font-display font-bold mt-4 mb-3" style={{ color: WHITE }}>{tr("Éditeur du site", "Site publisher", "Herausgeber der Website")}</h2>
          ...
          <div>
            <h2 className="titre-section font-display font-bold mt-6 mb-3" style={{ color: WHITE }}>{tr("Hébergeur", "Host", "Hosting-Anbieter")}</h2>
          ...
          <div>
            <h2 className="titre-section font-display font-bold mt-6 mb-3" style={{ color: WHITE }}>{tr("Propriété intellectuelle", "Intellectual property", "Geistiges Eigentum")}</h2>
          ...
          <div>
            <h2 className="titre-section font-display font-bold mt-6 mb-3" style={{ color: WHITE }}>{tr("Limitation de responsabilité", "Limitation of liability", "Haftungsbeschränkung")}</h2>
          ...
          <div>
            <h2 className="titre-section font-display font-bold mt-6 mb-3" style={{ color: WHITE }}>{tr("Droit applicable", "Applicable law", "Anwendbares Recht")}</h2>
